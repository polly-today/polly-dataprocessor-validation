...
from utils import get_args, load_prompt
from database import load_inputs, insert_run, update_run, dispose_engine, update_results
from comparison import compare_llm_to_target_output
from config import (
    manual_prompt_path,
...
async def main():
    ...
    # Generate a unique run ID and batch ID
    ...
    for input_id in input_ids_to_validate:
        ...
        # TO DO: Adjust country code within labeled_data.csv to match the country codes in the LLM output
        ...
        # TODO: Save the validation results to database
        value_comparison_df["run_id"] = run_id
        value_comparison_df["batch_id"] = batch_id
        # Set all target_value and llm_value to string type
